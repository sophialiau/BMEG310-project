...
# Keep only patients present in both clinical and mutation data
...
# 1) Detect stage column automatically
stage_candidates <- grep("stage|Stage|STAGE|pathologic|Pathologic",
                         names(clinical),
                         value = TRUE)
