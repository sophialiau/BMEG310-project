...
res_2v4 <- as.data.frame(res_1v4)
res_2v4$Gene <- rownames(res_1v4)
...
res_3v4 <- as.data.frame(res_1v4)
res_3v4$Gene <- rownames(res_1v4)
...
## Keep only patients with valid OS info
...
## Match filtered expression to OS patients
...
```{r}
top_n <- 6   # top 6 genes highlighted in the volcano

# Get top survival genes 
